...
digraph {
  ...
  data [label = 'Extant and fossil data', shape = folder, fillcolor = grey]
  explore [label = 'Data exploration', fillcolor = '#E7298A']
  outlier [label = 'Outlier detection and removal', fillcolor = '#E7298A']
  impute [label = 'Estimating missing values for fossil data', fillcolor = '#E7298A']
  perf [label = 'Imputation performance and variable correlation', fillcolor = '#E7298A']
  split [label = 'Train-Test split', fillcolor = '#E7298A']
  model [label = 'Fitting multinomial logistic model', fillcolor = '#E7298A']
  validation [label = 'Model performance using cross-validation', fillcolor = '#E7298A']
  prediction [label = 'Fossil prediction', fillcolor = '#E7298A']
...
```{r}
# Data Input.
Turtle.Df <- openxlsx::read.xlsx(xlsxFile = "Measurement File.xlsx")
...
Humerus.Path <- "Imputation-Performance_Humerus.xlsx"
Humerus_list <- list()
# Import data file
for(i in c(1:4)) {
...
Ulna.Path <- "Imputation-Performance_Ulna.xlsx"
Ulna_list <- list()
...
Digit.Path <- "Imputation-Performance_Digit.xlsx"
Digit_list <- list()
